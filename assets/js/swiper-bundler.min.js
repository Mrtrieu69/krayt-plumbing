...
!(function (e, t) {
        ...
        for (let s = 1; s < arguments.length; s += 1) {
            ...
            if (null != a && !c(a)) {
                ...
                for (let t = 0, i = s.length; t < i; t += 1) {
                    ...
                    void 0 !== r &&
                        r.enumerable &&
                        (d(e[i]) && d(a[i]) ? (a[i].__swiper__ ? (e[i] = a[i]) : p(e[i], a[i])) : !d(e[i]) && d(a[i]) ? ((e[i] = {}), a[i].__swiper__ ? (e[i] = a[i]) : p(e[i], a[i])) : (e[i] = a[i]));
                }
            }
        }
        return e;
    ...
    const A = (e, t) => {
        ...
        $ = (e) => {
            ...
            else for (let a = Math.max(r - t, 0); a <= Math.min(r + t, s - 1); a += 1) a !== i && a > r && k(e, a);
        };
    var I = {
        updateSize: function () {
            const e = this;
    ...
    const pe = [
                ...
                a("setTransition", (e, s) => {
                    t.params.parallax.enabled &&
                        (function (e) {
                            ...
                            const { el: s } = t;
                            s.querySelectorAll("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").forEach(
                                (t) => {
        ...
        function (e) {
            ...
            Object.defineProperty(t.zoom, "scale", {
                ...
                Object.assign(t.zoom, { enable: k, disable: $, in: P, out: L, toggle: z });
        },
        function (e) {
            let { swiper: t, extendParams: s, on: a } = e;
            function i(e, t) {
